...
!!! info "Práctica guiada"
    Relees el componente que ya construiste en el Tema 4, esta vez bajo la óptica de "componente" de la teoría, y lo extiendes con un método nuevo siguiendo el mismo patrón.
...
Tu `CatalogoConsultaService`/`CatalogoConsultaServiceImpl` de la Actividad 4.1.
