...
![Lo que ves y dónde ocurre el trabajo en un Dev Container](img/devcontainers/devcontainer_dos_mitades.png)
...
![Los seis pasos hasta trabajar dentro del contenedor](img/devcontainers/devcontainer_flujo_pasos.png)
...
![Qué controla cada campo del devcontainer.json](img/devcontainers/devcontainer_json_anatomia.png)
...
![Docker crea los contenedores; Dev Containers conecta el editor](img/devcontainers/devcontainer_vs_contenedor_servicio.png)
