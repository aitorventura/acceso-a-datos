...
> **Excepción — temas sin entrega evaluable** (p. ej. Tema 0, de repaso/introducción): al no
> haber nota ni entrega, la solución en `.docx` **sí** se publica en `docs/temaX/plantillas/`
> como `Actividad_X_Y_Solucion.docx`, enlazada desde el `.md` de la actividad. Esta excepción
> no aplica a temas evaluables.
